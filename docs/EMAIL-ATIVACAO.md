...
A tela de ativação está publicada. Após a autorização específica da proprietária, um único código nativo foi emitido em 11/09/2026 às 04:58:30 UTC, sem envio de e-mail. A função temporária foi imediatamente desativada e retorna HTTP 410. A senha é escolhida pela titular; o registro da operação, sem código ou credenciais, está em [PRIMEIRA-SENHA.md](PRIMEIRA-SENHA.md).
