...
Estado mais recente: **Render live**, deploy `dep-dahmrvnqj5pc739m2hf0`, commit `c2b5d9567f192971452b556296cd18641cc5c09a`, publicado às 02:58:38 UTC de 11/09/2026. A conexão PostgreSQL com TLS e as verificações de permissões passaram. URL: `https://elo-validacao.onrender.com`. A abertura externa não pôde ser verificada pelas ferramentas desta sessão. Próximo passo: configurar as URLs do Auth no painel e confirmar o acesso da proprietária; importação da assistência e e-mails continuam pendentes. Não criar outro servidor nem regenerar segredos.
