-- PostgreSQL schema generated from db/schema.ts; role isolation is reviewed explicitly.
...
-- Browser roles have no access. Only the authenticated Next.js server uses elo_backend.
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname='elo_backend') THEN
    CREATE ROLE elo_backend NOLOGIN NOINHERIT;
  END IF;
END $$;
GRANT USAGE ON SCHEMA public, auth TO elo_backend;
GRANT SELECT (id,user_id,not_after) ON auth.sessions TO elo_backend;
REVOKE ALL ON TABLE public."workspaces" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."workspaces" TO elo_backend;
CREATE POLICY elo_server_access ON public."workspaces" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."pieces" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."pieces" TO elo_backend;
CREATE POLICY elo_server_access ON public."pieces" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."merchants" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."merchants" TO elo_backend;
CREATE POLICY elo_server_access ON public."merchants" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."loans" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."loans" TO elo_backend;
CREATE POLICY elo_server_access ON public."loans" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."loan_items" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."loan_items" TO elo_backend;
CREATE POLICY elo_server_access ON public."loan_items" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."loan_events" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."loan_events" TO elo_backend;
CREATE POLICY elo_server_access ON public."loan_events" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."receivables" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."receivables" TO elo_backend;
CREATE POLICY elo_server_access ON public."receivables" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."payments" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."payments" TO elo_backend;
CREATE POLICY elo_server_access ON public."payments" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."notices" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."notices" TO elo_backend;
CREATE POLICY elo_server_access ON public."notices" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."movements" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."movements" TO elo_backend;
CREATE POLICY elo_server_access ON public."movements" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."commands" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."commands" TO elo_backend;
CREATE POLICY elo_server_access ON public."commands" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."email_outbox" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."email_outbox" TO elo_backend;
CREATE POLICY elo_server_access ON public."email_outbox" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."messaging_connections" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."messaging_connections" TO elo_backend;
CREATE POLICY elo_server_access ON public."messaging_connections" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
REVOKE ALL ON TABLE public."gmail_setups" FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public."gmail_setups" TO elo_backend;
CREATE POLICY elo_server_access ON public."gmail_setups" FOR ALL TO elo_backend USING (true) WITH CHECK (true);
