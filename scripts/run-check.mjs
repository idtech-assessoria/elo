...
export async function runCheck(entry, buildOptions = {}) {
  ...
  try {
    ...
    await build({ entryPoints: [entry], outfile: file, bundle: true, packages: 'external', platform: 'node', format: 'esm', target: 'node22', ...buildOptions });
